...
const tools_techstack = () => {
    return (
        <div className='flex flex-wrap gap-3'>
            {/* Blender */}
            <div className="group hover:bg-gradient-to-br from-yellow-900/20 to-red-900/20 border border-yellow-500/30 rounded-lg p-3 hover:border-yellow-400/60 transition-all duration-300">
            ...
            <div
                className="group hover:bg-gradient-to-br from-yellow-900/20 to-red-900/20 border border-yellow-500/30 rounded-lg p-3 hover:border-yellow-400/60 transition-all duration-300"
            >
                <div className="flex items-center justify-center gap-2">
            ...
            >
                <div className="flex items-center justify-center gap-2">
                    ...
                    </svg>                    <span className="text-gray-200 inter font-medium group-hover:text-yellow-300">
                        Vite
                    </span>
                </div>
            </div>
            ...
            >
                <div className="flex items-center justify-center gap-2">
                    <svg className=" w-5 invert h-5 mb-1 text-orange-400 group-hover:scale-110 transition-transform" xmlns="http://www.w3.org/2000/svg" width="128" height="128" viewBox="0 0 128 128"><path style={{ fillRule: "nonzero", fill: "#000", fillOpacity: 1 }} d="M63.984 17.184 127.964 128H0Zm0 0" /></svg>
            ...
            >
                <div className="flex items-center justify-center gap-2">
                    <svg className=" w-5 h-5 mb-0.5 invert text-orange-400 group-hover:scale-110 transition-transform" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 100 100"><path fill="#000" d="M75.886.027c-13.002-.612-23.935 8.79-25.8 21.178-.074.575-.185 1.13-.277 1.687-2.9 15.429-16.4 27.112-32.615 27.112-5.78 0-11.21-1.483-15.938-4.08A.843.843 0 0 0 0 46.666v53.333h49.79V62.503c0-6.899 5.578-12.5 12.448-12.5h12.448c14.09 0 25.43-11.738 24.876-26.017C99.064 11.136 88.685.64 75.886.027" /></svg>
                    <span className="text-gray-200 inter font-medium group-hover:text-yellow-300">
                        Render
                    </span>
                </div>
...
export default tools_techstack
